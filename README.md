...
**GitHub Pages:** Push to the `main` branch to trigger the GitHub Actions workflow. In the repo go to **Settings → Pages**, set **Source** to **GitHub Actions**. The app is served at `https://<username>.github.io/material-tailwind-dashboard-react/`.
